Page({
  ...
  formSubmit: function (e) {
    ...
    wx.request({
      url: "https://serv.huihuagongxue.top/IS/public/sign",
      method: "POST",
      data: {
        name: name,
        select: select,
  ...
  onLoad: function (id) {
    ...
    var url ="https://serv.huihuagongxue.top/IS/public/singleshowpro?id="+id;
    var url_class = "https://serv.huihuagongxue.top/IS/public/singleshowclass?id=" + id;
    var that = this
    wx.request({
      url: url,
      method: "POST",
